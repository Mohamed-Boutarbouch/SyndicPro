 ...
 */
final class Version20250905143802 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE receipt (id INT AUTO_INCREMENT NOT NULL, created_by_id INT DEFAULT NULL, file_path VARCHAR(255) NOT NULL, placeholders JSON NOT NULL, INDEX IDX_5399B645B03A8386 (created_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE receipt ADD CONSTRAINT FK_5399B645B03A8386 FOREIGN KEY (created_by_id) REFERENCES user (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE receipt DROP FOREIGN KEY FK_5399B645B03A8386');
